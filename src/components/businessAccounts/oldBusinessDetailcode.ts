...
import { Plus, ChevronLeft, ChevronRight, Search, Edit2, ArrowUpDown, Settings, MoreVertical, SkipBack, StepBackIcon, SendToBackIcon, LucideBackpack, ArrowLeft } from 'lucide-react';
    ...
    <>
      {!showInfo ? (
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="h-12">
                      ...
                      <TableHead className="w-[250px] cursor-pointer hover:bg-muted/50" onClick={() => handleSort('email')}>
                        <div className="flex items-center gap-2">Total Team members <ArrowUpDown className="h-4 w-4 text-muted-foreground" /></div>
                      </TableHead>
                    ...
                    {isLoadingData ? (
                      ...
                      sortedTeamMembers.map(member => (
                        <TableRow key={member._id} className="h-12">
                          ...
                          {/* --- MODIFIED: Replaced direct button with a Popover for actions --- */}
        ...
        <>
          ...
          <>
            <Button size="sm" className="h-8 px-3 text-xs border-0"> Go Back</Button >
            <Button
