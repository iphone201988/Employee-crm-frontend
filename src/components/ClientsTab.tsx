...
import { Users, Download, Eye, ChevronUp, ChevronDown, EyeOff, Plus, MoreHorizontal } from 'lucide-react';
      ...
      {selectedClientForDetails && (
        <ClientDetailsDialog
          ...
          clientData={{
            ...
            customerNumber: 'CU-' + selectedClientForDetails.clientRef,
            clientType: 'Limited Company',
            address: '123 Business Street, Dublin 2, Ireland',
            contactPerson: 'John Doe',
            email: 'contact@' + selectedClientForDetails.name.toLowerCase().replace(/\s+/g, '') + '.ie',
            phone: '+353 1 234 5678',
            takeOnDate: '2023-01-15',
            clientTags: ['Priority Client', 'Monthly Accounts'],
            taxes: ['VAT', 'IT', 'CT']
          }}
        />
      )}
